...
main <-function(){
  ...
  CP_WFABC_diploid_modelchoice(N,t,t0,h_fixed,h_given,s_start,sample_times,N_sample,N_allele,min_freq,max_sims,no_sim,best_sim,set_seed=TRUE,post_graph,post_2D_M1)
}
