...
CP_WFABC_haploid_estimator<-function(N=1000,t=100,t0=1,s_start=1,sample_times=c(),N_sample=c(),N_allele=data.frame(),min_freq=0.02,max_sims=1,no_sim=1000000,best_sim=1000,set_seed=TRUE,post_graph=FALSE,post_2D_M1=FALSE)
{
  # ploidy
  ploidy <- 1
  N <- round(N)
